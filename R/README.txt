...
./mask/ : Contains the code used to generate the masks in the numerical experiment used to validate DGM posterior sampling via MCMC
...
The following R packages are necessary to run the code: 
  * From the CRAN: Matrix, fields, RcppEigen, rhdf5, RTriangle, tictoc, terra, scoringRules, spatsat.random
