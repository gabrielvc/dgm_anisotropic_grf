...
coefsChebApprox <- function(h_, M, a, b, verbose = 0L) {
    .Call('_NSGP_coefsChebApprox', PACKAGE = 'NSGP', h_, M, a, b, verbose)
}
...
prodChebDecompVec <- function(S, Coefs, a, b, V) {
    .Call('_NSGP_prodChebDecompVec', PACKAGE = 'NSGP', S, Coefs, a, b, V)
}
...
evalCheb <- function(x, n, a = -1.0, b = 1.0) {
    .Call('_NSGP_evalCheb', PACKAGE = 'NSGP', x, n, a, b)
}
...
evalChebDecompPts <- function(x, Coefs, a, b) {
    .Call('_NSGP_evalChebDecompPts', PACKAGE = 'NSGP', x, Coefs, a, b)
}
...
evalChebDecompMat <- function(S, Coefs, a, b) {
    .Call('_NSGP_evalChebDecompMat', PACKAGE = 'NSGP', S, Coefs, a, b)
}
...
matFEM2d <- function(nodeMat, triMat, triMetricMat, triPotCoeffs = NULL, triDiffCoeffs = NULL, massLumping = TRUE) {
    .Call('_NSGP_matFEM2d', PACKAGE = 'NSGP', nodeMat, triMat, triMetricMat, triPotCoeffs, triDiffCoeffs, massLumping)
}
...
matFEM1d <- function(nodeMat, triMat, triMetricMat, triPotCoeffs = NULL, triDiffCoeffs = NULL, massLumping = TRUE) {
    .Call('_NSGP_matFEM1d', PACKAGE = 'NSGP', nodeMat, triMat, triMetricMat, triPotCoeffs, triDiffCoeffs, massLumping)
}

triMetricCompute2d <- function(nodeMat, triMat, knots, val_f, val_rho1, val_rho2, m = 3L, p = 2L, lambda = 0, rho_min = 0.001, rho_max = 1) {
    .Call('_NSGP_triMetricCompute2d', PACKAGE = 'NSGP', nodeMat, triMat, knots, val_f, val_rho1, val_rho2, m, p, lambda, rho_min, rho_max)
}

loglikelihood <- function(theta, Y, A, nodeMat, triMat, knots, m = 3L, p = 2L, lambda = 0, rho_min = 0.001) {
    .Call('_NSGP_loglikelihood', PACKAGE = 'NSGP', theta, Y, A, nodeMat, triMat, knots, m, p, lambda, rho_min)
}

KrigNodes <- function(theta, Y, A, nodeMat, triMat, knots, m = 3L, p = 2L, lambda = 0, rho_min = 0.001) {
    .Call('_NSGP_KrigNodes', PACKAGE = 'NSGP', theta, Y, A, nodeMat, triMat, knots, m, p, lambda, rho_min)
}

NCondSampleNodes <- function(theta, W, nodeMat, triMat, knots, m = 3L, p = 2L, lambda = 0, rho_min = 0.001) {
    .Call('_NSGP_NCondSampleNodes', PACKAGE = 'NSGP', theta, W, nodeMat, triMat, knots, m, p, lambda, rho_min)
}

CondSampleNodes <- function(theta, Y, A, W, eps, nodeMat, triMat, knots, m = 3L, p = 2L, lambda = 0, rho_min = 0.001) {
    .Call('_NSGP_CondSampleNodes', PACKAGE = 'NSGP', theta, Y, A, W, eps, nodeMat, triMat, knots, m, p, lambda, rho_min)
}

TPspline <- function(knots, val, m, p = 2L, lambda = 0) {
    .Call('_NSGP_TPspline', PACKAGE = 'NSGP', knots, val, m, p, lambda)
}

evalTPSpline <- function(pts, knots, val, m, p = 2L, lambda = 0) {
    .Call('_NSGP_evalTPSpline', PACKAGE = 'NSGP', pts, knots, val, m, p, lambda)
}

evalGradTPSpline <- function(pts, knots, val, m, p = 2L, lambda = 0) {
    .Call('_NSGP_evalGradTPSpline', PACKAGE = 'NSGP', pts, knots, val, m, p, lambda)
}

matCovarTPS <- function(xcoord, knots, m = 3L, p = 2L) {
    .Call('_NSGP_matCovarTPS', PACKAGE = 'NSGP', xcoord, knots, m, p)
}

getTPSvalMat <- function(knots, m = 3L, p = 2L, lambda = 0) {
    .Call('_NSGP_getTPSvalMat', PACKAGE = 'NSGP', knots, m, p, lambda)
}

argSort <- function(array) {
    .Call('_NSGP_argSort', PACKAGE = 'NSGP', array)
}

lgt <- function(x, rho_min = 0, rho_max = 1) {
    .Call('_NSGP_lgt', PACKAGE = 'NSGP', x, rho_min, rho_max)
}

lgtInv <- function(x, rho_min = 0, rho_max = 1) {
    .Call('_NSGP_lgtInv', PACKAGE = 'NSGP', x, rho_min, rho_max)
}

sphBarCoordBT <- function(sphPts, nodeMat, triMat, triBar) {
    .Call('_NSGP_sphBarCoordBT', PACKAGE = 'NSGP', sphPts, nodeMat, triMat, triBar)
}

BT <- function(triBar, query) {
    .Call('_NSGP_BT', PACKAGE = 'NSGP', triBar, query)
}

main <- function() {
    .Call('_NSGP_main', PACKAGE = 'NSGP')
}

simChebChol <- function(C, R, Coefs, a, b, V) {
    .Call('_NSGP_simChebChol', PACKAGE = 'NSGP', C, R, Coefs, a, b, V)
}

projectNoise <- function(C_fine, C_coarse, Amat, W) {
    .Call('_NSGP_projectNoise', PACKAGE = 'NSGP', C_fine, C_coarse, Amat, W)
}

maternCov <- function(theta, rho) {
    .Call('_NSGP_maternCov', PACKAGE = 'NSGP', theta, rho)
}

covMatMatern <- function(theta, Coord1, Coord2) {
    .Call('_NSGP_covMatMatern', PACKAGE = 'NSGP', theta, Coord1, Coord2)
}

loglikStat <- function(theta, Yobs, obsCoord, tau2 = 0) {
    .Call('_NSGP_loglikStat', PACKAGE = 'NSGP', theta, Yobs, obsCoord, tau2)
}

KrigStat <- function(tarCoord, theta, Yobs, obsCoord, tau2 = 0) {
    .Call('_NSGP_KrigStat', PACKAGE = 'NSGP', tarCoord, theta, Yobs, obsCoord, tau2)
}

KrigGaniso <- function(tarCoord, theta, Yobs, obsCoord, tau2 = 0) {
    .Call('_NSGP_KrigGaniso', PACKAGE = 'NSGP', tarCoord, theta, Yobs, obsCoord, tau2)
}

NCondSampleStat <- function(tarCoord, theta, W) {
    .Call('_NSGP_NCondSampleStat', PACKAGE = 'NSGP', tarCoord, theta, W)
}

CondSampleStat <- function(tarCoord, theta, Yobs, obsCoord, W, eps, tau2 = 0) {
    .Call('_NSGP_CondSampleStat', PACKAGE = 'NSGP', tarCoord, theta, Yobs, obsCoord, W, eps, tau2)
}

loglikGAniso <- function(theta, Yobs, obsCoord, tau2 = 0) {
    .Call('_NSGP_loglikGAniso', PACKAGE = 'NSGP', theta, Yobs, obsCoord, tau2)
}

logPostGAniso <- function(theta, Yobs, obsCoord, tau2 = 0) {
    .Call('_NSGP_logPostGAniso', PACKAGE = 'NSGP', theta, Yobs, obsCoord, tau2)
}

RW_MCMC <- function(theta_init, Yobs, obsCoord, tau2 = 0, nbIter = 100L, Thinning = 10L, stdVec) {
    .Call('_NSGP_RW_MCMC', PACKAGE = 'NSGP', theta_init, Yobs, obsCoord, tau2, nbIter, Thinning, stdVec)
}

rayTriangleIntersect <- function(dir, v0, v1, v2) {
    .Call('_NSGP_rayTriangleIntersect', PACKAGE = 'NSGP', dir, v0, v1, v2)
}

sphBarCoord <- function(sphPts, nodeMat, triMat) {
    .Call('_NSGP_sphBarCoord', PACKAGE = 'NSGP', sphPts, nodeMat, triMat)
}

sphBarCoordFast <- function(sphPts, nodeMat, triMat, triBar) {
    .Call('_NSGP_sphBarCoordFast', PACKAGE = 'NSGP', sphPts, nodeMat, triMat, triBar)
}

sphAnglesBarCoord <- function(sphPtsAngles, nodeMat, triMat) {
    .Call('_NSGP_sphAnglesBarCoord', PACKAGE = 'NSGP', sphPtsAngles, nodeMat, triMat)
}
